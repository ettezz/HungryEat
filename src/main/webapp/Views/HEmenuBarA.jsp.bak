	...
	<body>
		<% 
			if (session.getAttribute("ROLE_TYPE") == null){
				...
				if (!session.getAttribute("ROLE_TYPE").toString().equals("A")){
					out.println("<script type='text/javascript'>alert('查無使用者權限');</script>");
					out.println("<script type='text/javascript'>window.location.href='" + request.getContextPath() + "/Views/Bindex.jsp';</script>");
				}
				else{
			...
			<div class="container">
			  <div class="row">
				<div class="tm-top-header-inner">
				  ...
				  <nav class="tm-nav">
					<ul>
                        <li><a href="${pageContext.request.contextPath}/Views/AupProduct.jsp">維護商品資料</a></li>
                        <li><a href="${pageContext.request.contextPath}/Views/Aorder.jsp">查看訂單</a></li>
                        <li><a href="${pageContext.request.contextPath}/Views/AaddStaff.jsp">設定外送員</a></li>
